...
__all__ = ["ImageNet22kWebdataset"]
# "https://huggingface.co/datasets/timm/imagenet-22k-wds/resolve/main"
# "file:///media/nas2/Datasets/imagenet-22k-wds"


class ImageNet22kWebdataset(WebDataset):
    def __init__(
        self,
        split: str,
        ...
        **kwargs,
        ...
        hf_token = get_token()
        self.base_url = "file:///media/nas2/Datasets/imagenet-22k-wds"
